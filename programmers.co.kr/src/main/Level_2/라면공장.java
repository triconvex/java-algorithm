...
/*
문제 설명
라면 공장에서는 하루에 밀가루를 1톤씩 사용합니다. 원래 밀가루를 공급받던 공장의 고장으로
앞으로 k일 이후에야 밀가루를 공급받을 수 있기 때문에 해외 공장에서 밀가루를 수입해야 합니다.
...
public class 라면공장 {
    ...
    public int 참고할만한_풀이(int stock, int[] dates, int[] supplies, int k) {
        int answer = 0;
